...
const Header = () => {
    ...
    return (
        <>
            <header className="fixed top-0 left-0 right-0 bg-black h-[78px] z-50 w-full shadow-md" style = {{position: 'sticky', zIndex: 50, top: 0, backgroundColor: 'var(--black-color)', paddingTop: '10px'}}>
                <div className="flex justify-between items-center h-full px-6">
                    ...
                    <div className="flex items-center space-x-4" style={{display: 'flex', alignItems: 'center', flexDirection: 'row'}}>
                        ...
                        <img className="w-[130px] h-[40px] object-contain" src={homeBanneer} alt="GameStones Logo" onClick = {() => navigate("/")}/>
                        </div>
                        <Share2 style = {{marginLeft: '10px'}} size={24} color="var(--primary-color)" className="cursor-pointer hover:opacity-80 transition-opacity" />
                    </div>
